...
export default function useOnClickOuside(ref,handler) {
    useEffect(() => {
        const listener = (event) => {
            // If the click/touch event originated inside th ref element , do nothing
        ...
        // cleanup function to remove the event listeners when the component unmounts or when th ref/handler dependencies change
        return () => {
