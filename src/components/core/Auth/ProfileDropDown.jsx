...
const ProfileDropDown = () => {
  ...
  return (
    <button className='relative' onClick={() => setOpen(true)}>
      ...
      {open && (
        <div onClick={(e) => e.stopPropagation()} className='absolute top-[118%] right-0 z-20 divide-y-[1px] divide-richblack-700 overflow-hidden rounded-md border border-richblack-700 bg-richblack-800' ref={ref}>
